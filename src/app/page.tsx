    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary to-background">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Discover, save, and organize the blog posts you love. Build your personal library of knowledge with beautiful previews and smart organization.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link href="/auth/register">
              <Button size="lg" className="bg-primary text-white hover:bg-primary/90 shadow-lg h-12 px-8">
            ...
            <Link href="/auth/login">
              <Button variant="outline" size="lg" className="h-12 px-8 border-2 hover:bg-secondary/80">
                Sign In
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Powerful features designed to help you save, organize, and revisit your favorite articles.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <Card className="card-shadow hover:card-shadow-lg transition-all duration-300 border-0 bg-card/80 backdrop-blur-sm">
            ...
            <Card className="card-shadow hover:card-shadow-lg transition-all duration-300 border-0 bg-card/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-muted-foreground">
                  Get insights into your reading habits with a clean, organized dashboard that shows your progress and statistics.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="card-shadow hover:card-shadow-lg transition-all duration-300 border-0 bg-card/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-muted-foreground">
                  Track your reading progress, discover patterns, and see how your knowledge grows over time.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="card-shadow hover:card-shadow-lg transition-all duration-300 border-0 bg-card/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-muted-foreground">
                  Access your reading library from anywhere. Fully responsive design that works on all devices.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="card-shadow hover:card-shadow-lg transition-all duration-300 border-0 bg-card/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-muted-foreground">
                  Your reading data is private and secure. Only you can access your personal library of articles.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-3xl mx-auto text-center">
          <Card className="card-shadow-lg border-0 bg-gradient-to-r from-primary/5 to-accent/5 backdrop-blur-sm">
